            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-black/5">
                        <th class="px-8 py-5 text-[12px] font-semibold text-black/45 uppercase tracking-wider">Material
                            Name</th>
                        <th class="px-8 py-5 text-[12px] font-semibold text-black/45 uppercase tracking-wider">Price
                            (₸/cm³)</th>
                        <th class="px-8 py-5 text-[12px] font-semibold text-black/45 uppercase tracking-wider">Time
                            Multiplier</th>
                        <th class="px-8 py-5 text-[12px] font-semibold text-black/45 uppercase tracking-wider">Type</th>
                        <th
                ...
                <tbody>
                    @foreach($materials as $material)
                        <tr class="border-b border-black/5 hover:bg-black/[0.02] transition-colors">
                            ...
                            <td class="px-8 py-5">
                                <span class="text-[14px] text-black/60 font-medium">x{{ $material->time_multiplier }}</span>
                            </td>
                            <td class="px-8 py-5">
                                <span
