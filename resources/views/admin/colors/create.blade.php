<x-app-layout>
    <div class="max-w-[700px] mx-auto px-6 py-12">
        <div class="mb-10">
            <h1 class="text-[26px] font-[650] tracking-[-0.03em] text-black">Add New Color</h1>
            <p class="text-[13px] text-black/45 mt-1">Create a new color option for materials.</p>
        </div>
            ...
            <form action="{{ route('admin.colors.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required placeholder="e.g. Midnight Blue"
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <input type="color" id="hex_picker" class="w-12 h-12 rounded-[14px] cursor-pointer border-0 p-0 overflow-hidden" 
                                oninput="document.getElementById('hex_code').value = this.value">
                            <input type="text" name="hex_code" id="hex_code" required placeholder="#000000" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$"
