            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="slug" class="block text-sm font-medium text-gray-700 dark:text-gray-300">URL (опционально)</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="emoji" id="emoji" value="{{ old('emoji') }}" maxlength="10" placeholder="📁"
